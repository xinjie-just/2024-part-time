...
<template>
  <div class="search">
    ...
    <div class="search-item">
      ...
      <a-select v-model:value="status" id="status" placeholder="请选择"
        :options="[{ value: 1, label: '已发货' }, { value: 0, label: '未发货' }]" class="select"
...
const result = [
  { id: 1, orderId: "订单编号1", PKName: 'PK 品名称1', PKPhone: '13800138000', phone: '13800138000', PKSum: 100, goodsSum: 100, sendFree: 1, status: 1 },
  { id: 2, orderId: "订单编号2", PKName: 'PK 品名称2', PKPhone: '13800138000', phone: '13800138000', PKSum: 120, goodsSum: 120, sendFree: 0, status: 0 },
];
