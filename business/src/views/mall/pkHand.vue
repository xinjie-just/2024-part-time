...
<template>
  <div class="search">
    <div class="search-item">
      ...
      <a-input v-model:value.trim="name" id="name" allowClear placeholder="请输入 PK 手名称" class="input"
        @pressEnter="onSearch" />
    </div>
    <div class="search-item">
  ...
  <a-table :columns="columns" :dataSource="data" :pagination="false" size="small" :scroll="{ x: 1000, y: 400 }"
    ...
    <template #bodyCell="{ column, record, index }">
      ...
      <template v-else-if="column.key === 'action'">
        <a-popconfirm :title="`确认删除 PK 手 ${record.name} 吗？`" ok-text="确定"
...
const result = [
  ...
  { id: 2, name: "PK 手名称2", nickName: '昵称2', phone: '13800138001', winningPercentage: 12, points: 500 },
  { id: 3, name: "PK 手名称3", nickName: '昵称3', phone: '13800138002', winningPercentage: 12, points: 500 },
  { id: 4, name: "PK 手名称4", nickName: '昵称4', phone: '13800138003', winningPercentage: 12, points: 500 },
  { id: 5, name: "PK 手名称5", nickName: '昵称5', phone: '13800138004', winningPercentage: 12, points: 500 },
  { id: 6, name: "PK 手名称6", nickName: '昵称6', phone: '13800138005', winningPercentage: 12, points: 500 },
  { id: 7, name: "PK 手名称7", nickName: '昵称7', phone: '13800138006', winningPercentage: 12, points: 500 },
  { id: 8, name: "PK 手名称8", nickName: '昵称8', phone: '13800138007', winningPercentage: 12, points: 500 },
  { id: 9, name: "PK 手名称9", nickName: '昵称9', phone: '13800138008', winningPercentage: 12, points: 500 },
  { id: 10, name: "PK 手名称10", nickName: '昵称10', phone: '13800138009', winningPercentage: 12, points: 500 },
  { id: 11, name: "PK 手名称11", nickName: '昵称11', phone: '13800138010', winningPercentage: 12, points: 500 },
  { id: 12, name: "PK 手名称12", nickName: '昵称12', phone: '13800138011', winningPercentage: 12, points: 500 },
  { id: 13, name: "PK 手名称13", nickName: '昵称13', phone: '13800138012', winningPercentage: 12, points: 500 },
  { id: 14, name: "PK 手名称14", nickName: '昵称14', phone: '13800138013', winningPercentage: 12, points: 500 },
  { id: 15, name: "PK 手名称15", nickName: '昵称15', phone: '13800138014', winningPercentage: 12, points: 500 },
  { id: 16, name: "PK 手名称16", nickName: '昵称16', phone: '13800138015', winningPercentage: 12, points: 500 },
  { id: 17, name: "PK 手名称17", nickName: '昵称17', phone: '13800138016', winningPercentage: 12, points: 500 },
  { id: 18, name: "PK 手名称18", nickName: '昵称18', phone: '13800138017', winningPercentage: 12, points: 500 },
  { id: 19, name: "PK 手名称19", nickName: '昵称19', phone: '13800138018', winningPercentage: 12, points: 500 },
  { id: 20, name: "PK 手名称20", nickName: '昵称20', phone: '13800138019', winningPercentage: 12, points: 500 },
  { id: 21, name: "PK 手名称21", nickName: '昵称21', phone: '13800138020', winningPercentage: 12, points: 500 },
  { id: 22, name: "PK 手名称22", nickName: '昵称22', phone: '13800138021', winningPercentage: 12, points: 500 },
];
